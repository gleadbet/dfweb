...
export class SocketService{
    ...
    // Below are ways we communicate via thw socket by "emitting" messages.
    public getStatus() {
    ...
    // Add alerting to send to backend .. something stopped.
    public sendAlert(almMesssage: string) {
        console.log(`alert: ${almMesssage}`)
        this._socket.emit('alarm', almMesssage);
    }

    // Observable that can be used to display -- Passing data
