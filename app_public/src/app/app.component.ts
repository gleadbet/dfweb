...
@Component({
  ...
  <nav class='navbar navbar-expand navbar-light bg-light'>
      ...
      <ul class='nav nav-pills'>
        ...
        <li><a class='nav-link' routerLinkActive='active' routerLink='/tsds'>TS Booth</a></li>
...
export class AppComponent implements  OnInit {
  ...
  ngOnInit(): void {
    ...
    this.sendMessage({ text: 'ngOnInit(): Im alive!  Angular sending message from AppComponet:' });
    this.sendTime();
    this.getMessage();
  }   // End ngOnInit()
